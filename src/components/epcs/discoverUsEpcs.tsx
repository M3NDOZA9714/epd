  ...
  return (
    <section className="w-full flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-12 sm:py-16 md:py-20 lg:py-24 space-y-8 md:space-y-12">
      <div className="flex flex-col items-center justify-center gap-4 sm:gap-6">
        ...
        <div className="text-[#0094D9] text-center font-poppins text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold leading-tight sm:leading-snug md:leading-relaxed tracking-tighter px-4">
          Soluciones EPC que Transforman la Infraestructura Energética de la
          Región
        </div>

        <div className="flex flex-col gap-4 sm:gap-6 text-[#364153] font-poppins text-sm sm:text-base md:text-lg lg:text-xl font-normal leading-relaxed">
          <p>
            ...
            >
              {projects.map((project) => (
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 flex flex-col justify-end gap-2 sm:gap-3 md:gap-4 p-4 sm:p-6 md:p-8 lg:p-10 bg-[linear-gradient(0deg,rgba(0,0,0,0.80)_0%,rgba(0,0,0,0.40)_50%,rgba(0,0,0,0.00)_100%)]">
                    {/* Badge */}
                    ...
                    {/* Título */}
                    <div className="text-white font-poppins text-base sm:text-lg md:text-xl font-semibold leading-snug">
                      {project.title}
                    </div>

                    {/* Metadata */}
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 md:gap-6 text-white font-poppins text-xs sm:text-sm md:text-base">
                      {/* Ubicación */}
