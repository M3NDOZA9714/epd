...
import useImage from "../../assets/use/use.png";
export const Use = (): JSX.Element => {
  return (
        ...
        <div className="flex flex-col justify-between gap-7">
          <div className="flex flex-col gap-[30px] max-w-[643px]">
            ...
            <p className="text-[#364153] font-poppins text-xl font-medium leading-[34px]">
              Brindamos mantenimiento correctivo y preventivo para equipos de
              potencia, ofreciendo soluciones efectivas que resuelven problemas
              de operación y prolongan la vida útil de sus activos. Nuestro
              equipo especializado atiende fallas de emergencia con rapidez y
              precisión, garantizando que su sistema vuelva a operar con
