    ...
    <section className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-12 sm:py-16 md:py-20 lg:py-24 space-y-8 md:space-y-12">
      ...
      <div className="w-full space-y-8 md:space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
          ...
          {/* Right: Content */}
          <div className="h-full flex flex-col md:space-y-6 justify-center order-1 lg:order-2">
            ...
            <h3 className="text-[#14559C] font-poppins text-2xl sm:text-3xl md:text-4xl font-bold leading-tight">
