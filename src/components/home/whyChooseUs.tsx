...
export const WhyChooseUs = (): JSX.Element => {
  return (
    <section className="w-full flex flex-col justify-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-12 sm:py-16 md:py-20 lg:py-24 space-y-8 md:space-y-12">
      ...
      <p className="text-[#4A5565] text-center font-poppins text-xl font-medium leading-6">
        Nos distinguimos por nuestro compromiso con la excelencia y la
        satisfacción del cliente
      </p>

      <div className="grid grid-cols-1 gap-8 md:grid-cols-3 max-w-[1200px] mx-auto">
        {/* Tarjeta 1: Experiencia Especializada (Azul Oscuro) */}
        <div className="px-[32px] py-[35px] w-[369px] rounded-2xl bg-gradient-to-br from-[#F9FAFB] to-white shadow-lg flex flex-col space-y-6 items-center group">
          {/* Contenedor SVG: Se añadió flex justify-center items-center para centrar el SVG */}
          <div className="w-fit rounded-2xl aspect-square bg-gradient-to-br from-[#14559C] to-[#14559C]/80 p-5 transition-all duration-500 ease-in-out group-hover:scale-110 flex justify-center items-center">
            <svg
          ...
          {/* ✅ Contenedor de Texto: Se añadió flex-grow para ocupar el espacio vertical restante */}
          <div className="flex flex-col space-y-4 w-full flex-grow">
            <p className="text-[#14559C] text-center font-poppins text-xl font-semibold leading-6 self-stretch">
              Experiencia Especializada
            </p>
            <p className="text-[#4A5565] text-center font-poppins text-base font-normal leading-relaxed">
          ...
          <div className="relative flex justify-center border-t w-full border-gray h-[24.667px]">
            {/* Línea de color azul que se expande */}
        ...
        <div className="px-[32px] py-[35px] w-[369px] rounded-2xl bg-gradient-to-br from-[#F9FAFB] to-white shadow-lg flex flex-col space-y-6 items-center group">
          {/* Contenedor SVG: Se añadió flex justify-center items-center para centrar el SVG */}
          <div className="w-fit rounded-2xl aspect-square bg-gradient-to-br from-[#259DD7] to-[#259DD7]/80 p-5 transition-all duration-500 ease-in-out group-hover:scale-110 flex justify-center items-center">
            <svg
              width="40"
              height="40"
              viewBox="0 0 40 40"
          ...
          <div className="w-full flex-grow flex flex-col space-y-4">
            <p className="text-[#259DD7] text-center font-poppins text-xl font-semibold leading-6 self-stretch">
            ...
            <p className="text-[#4A5565] text-center font-poppins text-base font-normal leading-relaxed">
              ...
              seguros y respaldados por algos estándares de calidad.
            </p>
          </div>
        ...
        <div className="px-[32px] py-[35px] w-[369px] rounded-2xl bg-gradient-to-br from-[#F9FAFB] to-white shadow-lg flex flex-col space-y-6 items-center group">
          {/* Contenedor SVG: Se añadió flex justify-center items-center para centrar el SVG */}
          <div className="w-fit rounded-2xl aspect-square bg-gradient-to-br from-[#A11E1F] to-[#A11E1F]/80 p-5 transition-all duration-500 ease-in-out group-hover:scale-110 flex justify-center items-center">
            <svg
              width="40"
              height="40"
              viewBox="0 0 40 40"
          ...
          {/* ✅ Contenedor de Texto: Se añadió flex-grow para ocupar el espacio vertical restante */}
          <div className="w-full flex-grow flex flex-col space-y-4">
            <p className="text-[#A11E1F] text-center font-poppins text-xl font-semibold leading-6 self-stretch">
              Experiencia Especializada
            </p>
            <p className="text-[#4A5565] text-center font-poppins text-base font-normal leading-relaxed">
              Contamos con un equipo técnico altamente calificado y más de 18
      ...
      <div
        className="rounded-2xl bg-gradient-to-b from-[#14559C] to-[#259DD7] shadow-2xl max-w-[1200px] mx-auto px-[32px] py-[35px] flex flex-col space-y-6 items-center text-center">
        <p className="text-white text-center font-poppins text-xl font-semibold leading-6 self-stretch">
          ¿Listo para Comenzar tu Proyecto?
        </p>
        <p className="text-white/90 text-center font-poppins text-base font-normal leading-relaxed self-stretch">
          Ponte en contacto y déjanos acompañarte en el desarrollo de tu próximo
          proyecto.
        </p>
        <ButtonArrow variant="primary" size="lg">
          Contáctanos
        </ButtonArrow>
      </div>
    </section>
