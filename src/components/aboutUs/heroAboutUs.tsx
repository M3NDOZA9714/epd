...
export const HeroAboutUs = (): JSX.Element => {
  return (
    <div className="w-full h-full flex flex-col flex-1 justify-center items-start px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 space-y-4 sm:space-y-5 md:space-y-6 py-12 sm:py-16 md:py-20 lg:py-0">
      {/* Main Heading */}
