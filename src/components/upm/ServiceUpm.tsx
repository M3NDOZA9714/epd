...
import serviceUpm from "../../assets/upm/serviceUpm.jpg";

export const ServiceUpm = (): JSX.Element => {
  return (
    <section className="w-full flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-12 sm:py-16 md:py-20 lg:py-24 space-y-8 md:space-y-12">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        <div className="flex flex-col gap-6 rounded-3xl bg-gradient-to-b from-[#259DD7] to-[#14559C] p-[32px] max-w-[570px]">
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className="flex flex-col gap-3">
              {[
                "Ingeniería Integración de Tableros Pruebas y Comisionamiento  de PCyM para Subestaciones de Alta y Media Tensión.",
                "Estudios de Coordinación de Protecciones",
                "Estudios de Interconexión",
                "Estudios de Eficiencia Energética",
                "Certificación de Puntos de Medición Comercial",
                "Configuración, Parametrización y Ajuste de Relés de Protección",
        ...
        <div className="relative rounded-3xl overflow-hidden  max-w-[570px]">
          <img className="w-full h-full object-cover" src={serviceUpm} alt="" />
