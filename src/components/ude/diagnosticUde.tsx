...
export const DiagnosticUde = (): JSX.Element => {
  return (
    <section className="w-full flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-12 sm:py-16 md:py-20 lg:py-24 space-y-8 md:space-y-12">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        <div className="flex flex-col gap-6 rounded-3xl bg-gradient-to-b from-[#259DD7] to-[#14559C] p-[32px] max-w-[570px]">
          ...
          <div>
            <p className="text-white font-poppins text-xl font-semibold leading-6">
              Diagnósticos de Rutina
            </p>
            <p className="text-white font-poppins text-base font-medium leading-6 shrink-0 self-stretch">
              En Energía PD realizamos diagnósticos para equipos de potencia,
              aplicando pruebas como factor de potencia, aislamiento, relación
              de transformación, impedancia y resistencia óhmica en
              transformadores, generadores, TCs y TPs. Más que ejecutar pruebas,
              evaluamos el estado real del equipo y definimos planes de
              mantenimiento según su criticidad, asegurando confiabilidad y
              continuidad operativa. Si desea conocer más sobre nuestros
              diagnósticos, lo invitamos a ponerse en contacto con nuestro
              equipo.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className="flex flex-col gap-3">
              {[
                ...
                "Espectroscopía en el Dominio de la Frecuencia (DFR)",
                "Análisis de Respuesta en Frecuencia Barrida (SFRA)",
                "Pureza de Gas SF6",
                "DGA",
                "Prueba de Descarga y Capacidad del Banco de Baterías",
